...
var ParseZipExtraField = require('./ParseZipExtraField');
var Buffer = require('./Buffer');
var ParseZipDateTime = require('./ParseZipDateTime');
...
ParseZip.prototype._readRecord = function () {
  var self = this;
...
ParseZip.prototype._readCrxHeader = function() {
  var self = this;
  return self.pull(12).then(function(data) {
    self.crxHeader = binary.ParseZip(data)
      .word32lu('version')
...
ParseZip.prototype._readFile = function () {
  var self = this;
  return self.pull(26).then(function(data) {
    var vars = binary.ParseZip(data)
    ...
    vars.lastModifiedDateTime = ParseZipDateTime(vars.lastModifiedDate, vars.lastModifiedTime);
    ...
    return self.pull(vars.fileNameLength).then(function(fileNameBuffer) {
      ...
      return self.pull(vars.extraFieldLength).then(function(extraField) {
        var extra = ParseZipExtraField(extraField, vars);
...
ParseZip.prototype._processDataDescriptor = function (entry) {
  var self = this;
...
ParseZip.prototype._readCentralDirectoryFileHeader = function () {
  var self = this;
...
ParseZip.prototype._readEndOfCentralDirectoryRecord = function() {
  var self = this;
...
ParseZip.prototype.promise = function() {
  var self = this;
  return new Promise(function(resolve,reject) {
